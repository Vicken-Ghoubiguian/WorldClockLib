...
int main() {
    ...
    time_t datetime_for_winter_in_britain = wished_wday_in_choosen_month(utc_today, 2, 0, 2, 0, 0, LAST);
    ...
    time_t datetime_for_summer_in_britain = wished_wday_in_choosen_month(utc_today, 9, 0, 3, 0, 0, LAST);
